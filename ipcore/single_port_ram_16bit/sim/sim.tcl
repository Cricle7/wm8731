...
vsim -suppress 3486,3680,3781 +nowarn1 -c -sva -lib work single_port_ram_16bit_tb -l sim.log
add wave -position insertpoint sim:/single_port_ram_16bit_tb/U_single_port_ram_16bit/*
//run -all
